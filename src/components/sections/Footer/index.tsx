  ...
  return (
    <footer className="flex justify-center items-center flex-col bg-backgroundSecondary">
      <div className="px-[120px] w-full flex items-start gap-8 justify-between pt-6 flex-wrap ">
        ...
        <div className="flex items-start flex-col min-w-[400px] max-w-[400px]">
          <div><p className="text-2xl font-bold">Inscreva-se na nossa newsletter</p></div>
          <div className="flex items-center justify-start gap-2">
            <Image height={82} src={logo} alt="logo" />
            <p className="break-words text-lg">E fique atualizado com as mais quentes noticias do mundo <span className="font-bold">Geek!</span></p>
          </div>
      ...
      <div className="border-t-2 border-black w-full flex items-center justify-center py-6 mt-6">
